...
換問題就換用途、派發方式不變：理解正確性 / 重點涵蓋度 / 主旨明確度 / 閱讀負擔 / 語氣與讀者定位 / 翻成英文（詳見下段）。其中重點涵蓋度的判斷標準與其餘四項不同，比對的是作者的意圖清單與讀者的回報清單之間的差集——讀者不知道自己漏了什麼，所以直接問「你讀懂了嗎」問不出來。
...
- 核心規則摘要：
  ...
  - **物理化錯配（人工 grep）**：抽象概念（證據 / 論證 / 結論 / 判斷標準 / 方法 / 責任）配上承重、支撐、懸掛類動詞 — 「證據撐得住」「論證掛在某前提上」「這套說法會垮」。抽象概念沒有重量、支點與材料強度，那些動詞不帶進資訊，只把物理直覺借過來蓋住實際的關係；而且「撐得住」聽起來已經像答案，於是「支持什麼、到什麼範圍」不必被回答。判斷標準可機械執行：**問這個動詞照字面成立需要什麼物理條件**，需要重量或支點的就換掉。替換：足以支持 / 不足以支持、依賴 / 取決於、佐證、維持不久、負責。命中是候選不是判決 — 主詞是實體或系統負載（機器撐得住多少 QPS）合規、就地展開成可逐項對應的類比合規。**下面那串清單是抽樣、不是這一類的全部**：能進清單的只有違規義項佔該詞用法多數的詞，而本義合法的直譯（滑坡）與詞頻過高的泛用動詞（拿、承載）漏在外面，要靠判斷標準逐句掃或另設探針，判讀見 [#267](/report/keyword-list-needs-dominant-violating-sense/)。掃：`rg "撐得住|撐不住|撐得起|撐不起|能撐|撐住|撐起|撐不久|掛在|扛|垮|頂得住|咬得|咬合|啃|咬得|咬合|啃" content/`。判讀依 [#234](/report/word-choice-fits-concept-attributes/)。
