...
| **反思深度質疑**                            | 用戶說「太表層」「再想想」「這解釋不了」「為何不是」「更深一層」「還有其他可能嗎」 | **完整 WRAP 強制**：先擴增假設，再做反向驗證，最後回到可執行結論                |
| 提案評估                                    | 評估提案可行性                                                                     | 完整                                                                            |
...
> 完整 4 問操作細節見 `references/detailed-techniques.md` 「Tool selection check 詳細技巧」章節。
...
詳見 `references/anti-paternalism.md`（含規則設計中的 paternalism 悖論案例）。
