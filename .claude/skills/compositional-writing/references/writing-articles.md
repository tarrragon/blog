...
| 8   | Keyword bank（換工具）                                                                             | 跑 grep 比對固定 keyword list（口語修辭 / 廢話前綴 / 地區漂移 / 依賴 code / 裝飾符號）、不靠 reviewer 記憶——詳見 [colloquial-rhetoric](principles/colloquial-rhetoric-erodes-technical-precision.md) + [regional-terminology](principles/regional-terminology-alignment.md) + [prose-self-contained](principles/prose-self-contained-without-code-reference.md) + [decorative-symbols](principles/decorative-symbols-keyword-bank.md) |
