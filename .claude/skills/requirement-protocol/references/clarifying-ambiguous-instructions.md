...
三問的詳細展開（含 5 種篩選形式 / 跨情境範例 / 後端 + 演算法）見 [#58 篩選類指令的澄清時機](/report/filter-instruction-clarification/)；解法策略見 [#59 Filter × Source 合成策略五選一](/report/filter-source-composition-strategies/)。
...
- `spatial-instruction-clarification.md` — 空間 / 尺寸類
- `relative-position-instruction-clarification.md` — 相對位置類
- `isolation-instruction-clarification.md` — 隔離類
- `decide-vs-confirm-boundary.md` — 可決定 vs 該確認的完整判準
