...
這兩種型態的差距在真實服務裡很極端。一個電商在大促當天 24 小時收 1.67 億請求、峰值 3500 RPS，峰均比約 1.8——算溫和型，按峰值配一點超額就穩。搶票型服務則是另一個極端：整批票 5 分鐘賣完，峰值全集中在開賣的瞬間，峰均比比平緩型高出一個數量級以上，這種流量沒辦法靠「平均值加係數」規劃，得專門為那 5 分鐘設計。峰均比先算出來，才知道自己在哪一端。
...
- 把峰值從模型推出來、加多少安全係數 → [峰值估算](/devops/05-capacity-planning/peak-estimation/)
- 用壓測工具驗證這個模型撐不撐得住 → [壓力測試工具與方法](/devops/05-capacity-planning/load-testing-tools/)
