...
- **資訊分享**：撿到的文章或者資訊
- [書單推薦](/books/)：依主題整理值得投資時間的書 — 每本書解什麼問題、什麼階段讀最有效、哪些問題該去其他領域找答案，以及讀不動長篇文字時同一份知識走哪條路
...
- [SQL：這個語言為什麼長這樣](/sql/)：子句怎麼切、查詢怎麼讀、代價落在哪裡
...
- [Testing 測試策略](/testing/)：三層測試分層、mock 遮蔽機制、protocol integration test、客戶端可觀測性、agent 產出程式碼的判斷標準來源與品質閘門，從終端機 app 的實機測試教訓出發
