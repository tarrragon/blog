...
| [CLI](/linux/tools/cli/)   | TUI 工具、多工器、檔案管理器                  | CLI 工具的配置檔是 dotfile 管理的核心對象                                       |
...
| [模組二：Shell 配置](/linux/dotfile/02-shell-config/)                    | zsh/bash 結構化配置、模組化拆分、alias/function/PATH | .zshrc 該怎麼寫才不會長成一坨             |
