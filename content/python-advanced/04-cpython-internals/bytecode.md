...
- [3.2 記憶體管理與垃圾回收](/python-advanced/04-cpython-internals/memory-gc/)
...
*上一章：[記憶體管理與垃圾回收](/python-advanced/04-cpython-internals/memory-gc/)*
*下一章：[GIL 與執行緒模型](/python-advanced/04-cpython-internals/gil-threading/)*
