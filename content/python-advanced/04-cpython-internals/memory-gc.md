...
- [3.1 PyObject 與物件模型](/python-advanced/04-cpython-internals/object-model/)
...
*上一章：[PyObject 與物件模型](/python-advanced/04-cpython-internals/object-model/)*
*下一章：[Bytecode 與虛擬機](/python-advanced/04-cpython-internals/bytecode/)*
