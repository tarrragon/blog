...
本文承接 [終端機圖形化工具總覽](/cli/cli-graphical-tools-overview/) 的 TUI 工具脈絡，聚焦 git 線圖這個版控子題（最常被遠端開發者問到）。
...
git 線圖在整個遠端 CLI 工具選型中的位置，見 [終端機圖形化工具總覽](/cli/cli-graphical-tools-overview/) — 本篇屬其中的版控子題、與系統監控的 TUI 工具脈絡相承。
