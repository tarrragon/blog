...
多人（或多 AI agent）並行開發時問題更嚴重——每個人只看自己加的欄位，沒有人有動機去檢查 reset 的完整性。並行修改同一檔案的協調問題見 [parallel_agent_same_file_conflict](../work-log/parallel_agent_same_file_conflict.md)。
