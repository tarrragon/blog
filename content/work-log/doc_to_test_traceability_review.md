...
date: 2026-06-23
draft: false
description: "monitor 專案 v0.1.0 從 Proposal/Spec/UseCase 走到 Collector 實作的流程回顧。識別五個設計缺口：TDD Phase 模型缺新專案起手模式、靜態語言紅燈需要存根策略、測試缺少反向追溯、邊界條件缺回補流程、Ticket 拆分邊界需對齊測試變綠驗收點。記錄解決方案：追溯矩陣、存根策略、拆分判讀規則。"
