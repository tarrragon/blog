...
介面寬度之外還有一層前置條件：替身之所以出現在這裡，前提是測試邊界畫在單一類別。邊界畫在模組時這幾個協作者用真實實例，55 個方法的配置問題不會發生——但那條路要模組的內部結構撐得住真實建構。兩條路的取捨見 [Sociable vs Solitary Unit Test](/testing/knowledge-cards/unit-definition-two-schools/)。
