...
- commit message 裡若寫了對其他 repo 的 issue 引用，push 之前是唯一能無痕修改它的窗口 — 推上去之後對方 timeline 就有記錄，判斷標準見[commit message 引用外部 issue 會在對方 repo 留下事件](/work-log/github-cross-reference-from-commit-message/)
