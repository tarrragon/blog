...
slug: "pos_table_cart_lifecycle_decoupling"
date: 2026-07-10
draft: false
description: "兩個業務資源該綁死成一對一、還是解耦成獨立生命週期加綁定關係——判斷標準是有沒有業務操作需要其中一方獨立存活。以 POS 的提前結帳、純佔桌、外賣單推導桌位與購物車的聚合邊界，含組合空間大於業務空間時的非法組合封鎖。"
...
- 非法組合封鎖的原則層：[#222 約束要讓違反路徑走不通](/report/design-intent-needs-enforcement-layer/)——「提前結帳 + 釋放桌子」正是「不允許任意組合的欄位」判斷標準的另一個實例
