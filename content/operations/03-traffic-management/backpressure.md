...
- 主動的流量限制 → [Rate Limiting](/operations/03-traffic-management/rate-limiting/)
- 依賴服務失敗時的防護 → [熔斷器](/operations/03-traffic-management/circuit-breaker/)
- 突發流量時的組合策略 → [模組七 突發流量](/operations/07-burst-traffic/)
