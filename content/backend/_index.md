...
這項工作**逐篇獨立、可隨時中斷**，不需要規劃批次。目前 204 篇主章中，形態代理掃描有 140 篇兩項指標都未命中，但抽樣顯示其中有偽陰性（用其他措辭給了情境的也會落在這裡），實際缺口小於這個數字，逐篇判定時才算數。已完成 7.28 密碼學原語選型、7.29 API 認證信任邊界、11.6 向後相容的變更紀律三篇。
