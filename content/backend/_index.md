...
| 路線                       | 適合讀者                              | 建議順序                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | 讀完能做什麼                                                                                                                 |
| -------------------------- | ------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| 系統心智模型               | 想理解後端服務分工                    | 00 → knowledge cards → 01 / 02 / 03 的共同觀念 → [10.1 服務邊界](/backend/10-system-evolution/service-decomposition-boundaries/) / [0.19 雲端對照](/backend/00-service-selection/cloud-vendor-capability-mapping/) / [9.13 擴展軸](/backend/09-performance-capacity/scaling-axes/)                                                                                                                                                                                                                                                        | 能把需求分類成正式狀態、暫存副本、非同步交接、觀測、部署或可靠性問題、並用服務邊界與擴展軸描述系統走向                       |
