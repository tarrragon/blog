...
各模組的判讀類章節普遍只給機制屬性（描述某個機制具備什麼特性），沒給「什麼樣的系統會遇到」與「什麼事件會逼出這個動作」。缺這兩者時，讀者要能使用內容就得自己補上情境，而能補的人本來就會判斷了——實際受眾因此收斂成已經有經驗的人，與 AGENTS.md 原則六（預設讀者工程經驗有限、用現實服務案例補足經驗差距）不符。
