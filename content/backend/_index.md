...
讀者要看的三層結構、依目的分的閱讀路線與貫穿式 checkout 案例住在 [Backend 教材的閱讀路線](/backend/reading-paths/)；規模成長路線（撞牆訊號、要補的能力、從頭讀的順序、入門影片比喻對照）住在 [服務從能跑到能撐](/backend/scale-growth-walls/)。本頁不在網站上顯示，文章一律連到那兩篇、不連本頁錨點。
