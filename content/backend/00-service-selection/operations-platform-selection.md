...
- 多個 service instance 需要透過 load balancer 與 service discovery 協作
...
reliability pipeline 的核心責任是在事故前驗證系統承受能力。CI、load test、fuzz test、chaos test 都屬於可靠性驗證，但它們觀察的風險不同。
