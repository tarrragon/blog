...
本章不在[規模成長路線](/backend/scale-growth-walls/)上、是 sibling 工具型入口。要進規模成長路線、從 [10.1 服務拆分](/backend/10-system-evolution/service-decomposition-boundaries/) 或 [9.13 擴展軸](/backend/09-performance-capacity/scaling-axes/) 開始。
