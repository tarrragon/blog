...
| [0.22](/backend/00-service-selection/capability-buy-vs-build/)              | 能力級買 vs 建：feature-as-a-service   | 自建核心成立後、逐能力判斷外包還是自建：三種外包深度、no-code 到 dev-tool 光譜、買 vs 建判斷標準與整合接縫成本                                                                                                                                           |
