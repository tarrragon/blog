...
- ✅ 完全控制 query plan、易 tune
- ✅ 大規模 query 性能最好
- ❌ 易拼錯字、IDE 支援差
- ❌ 一不小心就 SQL injection（用 prepared statement / parameterized query）
...
- ✅ CRUD 操作快速、boilerplate 少
- ✅ 自動 mapping、自動 transaction
- ✅ migration 工具通常整合
- ❌ 隱藏 SQL 細節、易產生 N+1 query
- ❌ 複雜 query 反而比 raw SQL 難寫
- ❌ lazy loading 容易意外性能問題
