...
- [Citus Distributed](/backend/01-database/vendors/postgresql/citus-distributed.md)：extension 一例、可看 extension model
...
- [SQL Features Baseline](/backend/01-database/vendors/postgresql/sql-features-baseline.md)：extension 是 PG 結構性領先之一

## 相關連結

- [PostgreSQL vendor overview](/backend/01-database/vendors/postgresql/)
- [PG SQL Features Baseline](/backend/01-database/vendors/postgresql/sql-features-baseline.md)（extension 是結構優勢）
