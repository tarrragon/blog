...
**徵尾**：加 trigger 後 application 寫入 latency p99 從 5ms 漲到 25-50ms；high-throughput batch job 直接 timeout。
...
- 平行 Type F dogfood：[Redis Cluster Re-sharding](/backend/02-cache-redis/vendors/redis/cluster-resharding/)
