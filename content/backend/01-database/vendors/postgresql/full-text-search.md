...
- [JSONB Deep Dive](/backend/01-database/vendors/postgresql/jsonb-deep-dive/)：JSONB 跟 FTS 都用 GIN
- [Extension Ecosystem](/backend/01-database/vendors/postgresql/extension-ecosystem/)：pg_trgm / pgroonga / zhparser 都是 extension
...
- [PG Extension Ecosystem](/backend/01-database/vendors/postgresql/extension-ecosystem/)（pg_trgm / pgroonga）
- [PG JSONB Deep Dive](/backend/01-database/vendors/postgresql/jsonb-deep-dive/)（共用 GIN）
