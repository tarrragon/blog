...
- 按業務切多個小 cluster（[9.C4 DraftKings](/backend/09-performance-capacity/cases/draftkings-aurora-financial-ledger/) 200 個）、降低 blast radius
...
- Aurora storage architecture 深度（quorum-based、4 of 6 write、3 of 6 read）
