...
- 跟 [Aurora read-replica-scaling](/backend/01-database/vendors/aurora/) 共軸 cross-link：本篇從 DynamoDB 視角切入、Aurora 從讀副本視角切入、Frame 8 event-driven scaling 兩篇互引不重複展開
