...
- Cross-shard cascade：改 application 層 transaction 內 explicit DELETE child、或 *background [reconciliation](/backend/knowledge-cards/data-reconciliation/) job*（定期掃 orphan）
