...
date: 2026-05-01
description: "把驗證、migration、相容性納入放行條件"
weight: 8
...
- 07 資安：[7.22 資安風險如何進入 Release Gate](/backend/07-security-data-protection/security-risk-in-release-gate/) 給資安側的分級判斷標準（變更動到哪一類資產、回退收不收得回風險）與必備控制的導出方式
