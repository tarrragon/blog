...
| 案例方向                                                                                                                 | 對應主題                                                   |
| ------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------- |
| [Google：Error Budget 與 Release Gating](/backend/06-reliability/cases/google/error-budget-policy-and-release-gating/)   | SLI / SLO / error budget 原典、多源聚合 SLO 平台的對齊對象 |
| [Honeycomb：Burn Rate 驅動可靠性](/backend/06-reliability/cases/honeycomb/burn-rate-driven-reliability-operations/)      | burn rate alert 對應 SLO 平台的 alert policy               |
| [Microsoft：變更治理與可靠性門檻](/backend/06-reliability/cases/microsoft/change-management-and-reliability-governance/) | 企業合規 + SLO 治理的對應路徑                              |
