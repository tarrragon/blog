...
| 章節                                                                                                 | 主題                                     | 核心責任                                            |
| ---------------------------------------------------------------------------------------------------- | ---------------------------------------- | --------------------------------------------------- |
| [P1](/backend/06-reliability/cases/pinterest/cache-reliability-and-capacity-surprises/)              | 快取可靠性與容量驚奇                     | 在命中率崩落時維持可回復節奏與容量緩衝              |
| [P2](/backend/06-reliability/cases/pinterest/storage-migration-and-data-infrastructure-reliability/) | Storage Migration 與 Data Infrastructure | 大規模儲存遷移的漸進驗證與 dual-write / shadow read |
