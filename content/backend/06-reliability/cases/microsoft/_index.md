...
| 章節                                                                                              | 主題                                             | 核心責任                                           |
| ------------------------------------------------------------------------------------------------- | ------------------------------------------------ | -------------------------------------------------- |
| [MS1](/backend/06-reliability/cases/microsoft/change-management-and-reliability-governance/)      | 變更治理與可靠性門檻                             | 以風險分層與 release gate 降低系統性回歸           |
| [MS2](/backend/06-reliability/cases/microsoft/safe-deployment-practices-and-resilience-patterns/) | Safe Deployment Practices 與 Resilience Patterns | ring-based deployment 與標準化韌性設計模式的制度化 |
