...
| 章節                                                                                          | 主題                                  | 核心責任                                         |
| --------------------------------------------------------------------------------------------- | ------------------------------------- | ------------------------------------------------ |
| [L1](/backend/06-reliability/cases/linkedin/capacity-headroom-and-oncall-tiering/)            | Capacity 與 On-call 分層              | 把容量邊界與值班交接綁成同一套治理節奏           |
| [L2](/backend/06-reliability/cases/linkedin/automated-load-testing-and-capacity-forecasting/) | Automated Load Testing 與 Forecasting | 用持續壓測驅動容量預測，取代一次性壓測的容量規劃 |
