...
| 章節                                                                                | 主題                                  | 核心責任                                           |
| ----------------------------------------------------------------------------------- | ------------------------------------- | -------------------------------------------------- |
| [H1](/backend/06-reliability/cases/shopify/bfcm-capacity-and-game-day/)             | BFCM 容量治理與 Game Day              | 把季節性峰值壓力轉成可預演、可回寫的年度可靠性節奏 |
| [H2](/backend/06-reliability/cases/shopify/pod-architecture-and-resiliency-matrix/) | Pod Architecture 與 Resiliency Matrix | 多租戶隔離與系統化失敗模式盤點                     |
