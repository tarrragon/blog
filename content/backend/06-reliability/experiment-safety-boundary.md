...
date: 2026-05-02
description: "定義 chaos、load test、DR drill 的 [blast radius](/backend/knowledge-cards/blast-radius/)、停止條件與權限約束"
weight: 20
...
SLO burn 是最適合作為 stop condition 的可靠性訊號。它能把多個低層訊號聚合成使用者影響，並且直接接到 [error budget](/backend/knowledge-cards/error-budget/) 與 release policy。
