...
| 章節                                                           | 主題                                 | 關鍵收穫                                        |
| -------------------------------------------------------------- | ------------------------------------ | ----------------------------------------------- |
| [6.1](/backend/06-reliability/ci-pipeline/)                    | CI pipeline                          | 分層測試、快慢測試與 artifact 管理              |
| [6.2](/backend/06-reliability/load-testing/)                   | load test                            | 定義 workload、吞吐與延遲基準                   |
| [6.3](/backend/06-reliability/fuzz-campaign/)                  | fuzz campaign                        | 建立輸入邊界、corpus 與 crash reproduction      |
| [6.4](/backend/06-reliability/chaos-testing/)                  | chaos testing                        | 模擬 broker、DB、network 與節點故障             |
| [6.5](/backend/06-reliability/attacker-view-validation-risks/) | 攻擊者視角（紅隊）：驗證缺口弱點判讀 | 用驗證盲區、演練缺口與門檻失真檢查 release 風險 |
