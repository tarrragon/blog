...
- 來自 [7.4 資料保護與遮罩治理](../07-security-data-protection/data-protection-and-masking-governance/)：承接資料外送與回復排序的驗證場景。
- 來自 [7.7 稽核追蹤與責任邊界](../07-security-data-protection/audit-trail-and-accountability-boundary/)：承接事件證據完整性與回查演練。
- 來自紅隊 [7.R4 資源濫用與可用性破壞](../07-security-data-protection/red-team/resource-abuse/)：承接壓力放大路徑與降級回復驗證。
