...
Authentication 是 authorization 的前置條件。系統先確認身份，再判斷該身份能否操作某個資源。身份確認失敗時，後續權限判斷沒有可靠基礎。
...
Authentication 要處理 credential 保存、過期、撤銷、輪替、錯誤回應、登入風險與 audit。安全事件後要能追查是哪個身份與 credential 被使用。
