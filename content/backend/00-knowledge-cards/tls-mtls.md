...
TLS 是公開網路服務的基本傳輸保護。mTLS 常用在 service-to-service、內部 API、金融或高敏感資料傳輸場景，讓服務身份以憑證、[authentication](../authentication/) 與網路邊界共同判斷。

## 可觀察訊號與例子

系統需要 mTLS 的訊號是內部服務會傳遞付款、[PII](../pii/)、企業資料或高權限操作。服務身份與憑證輪替納入設計後，橫向移動風險可以被更早偵測與限制。
