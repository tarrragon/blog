...
指揮系統連接 [incident severity](../incident-severity/)、[escalation policy](../escalation-policy/) 與 [incident timeline](../incident-timeline/)。常見角色包括 incident commander、technical owner、communication owner 與 scribe。
