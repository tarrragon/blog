...
這條路徑的前置引用應該是 3.2 durable queue、3.3 outbox pattern、3.4 consumer design、[6.12 Idempotency 與 Replay 驗證](/backend/06-reliability/idempotency-replay/) 與 [6.23 Verification Evidence Handoff](/backend/06-reliability/verification-evidence-handoff/)。完成後可依 [Backend 學習路線](/backend/reading-paths/) 進入下一條服務路徑。
