...
| [3.2](durable-queue/)           | [durable queue](/backend/knowledge-cards/durable-queue) 與重試策略     | 規劃持久化、ack/nack、DLQ 與 retry                                                    |
| [3.3](outbox-pattern/)          | [outbox pattern](/backend/knowledge-cards/outbox-pattern) 與發佈一致性 | 把交易寫入與事件發佈分離                                                              |
| [3.4](consumer-design/)         | consumer 設計與去重                                                    | 設計 idempotency、[checkpoint](/backend/knowledge-cards/checkpoint/) 與 replay safety |
