...
4. 規模化路徑：單叢集 metadata 逼近上限時、評估分群（依關鍵程度分多叢集）、見 overview 的 [Cross-region 與分層叢集](/backend/03-message-queue/vendors/kafka/)段與 [LinkedIn Tiered Clusters](/backend/03-message-queue/cases/linkedin-kafka-tiered-clusters/)案例。
