...
# TODO: docker run -d -p 6379:6379 redis:7

# 2. XADD 寫入 stream
# TODO: redis-cli XADD mystream '*' field1 value1

# 3. XREAD 讀取
# TODO: redis-cli XREAD COUNT 10 STREAMS mystream 0
```
...
```bash
# TODO: XPENDING mystream mygroup
```
