...
# TODO: docker run -d --name rabbitmq -p 5672:5672 -p 15672:15672 rabbitmq:3-management

# 2. 連線到 management UI（http://localhost:15672、預設 guest/guest）
# TODO: 建 exchange / queue / binding 的 UI 流程

# 3. 用 rabbitmqctl 驗證
# TODO: rabbitmqctl list_queues / list_exchanges / list_bindings
```
...
```bash
# TODO: rabbitmqctl list_queues name messages messages_unacknowledged consumers
```
...
```bash
# TODO: rabbitmqctl list_connections / list_channels
```
