...
**Grafana OnCall 公開 customer 偏向 observability-first 團隊**：本案例庫尚無直接揭露 Grafana OnCall 使用細節的事故、待補 candidate 為 Grafana Labs 自家 Grafana Cloud incident 與 OSS adopter case。

| 案例方向               | 對應主題                        |
| ---------------------- | ------------------------------- |
| Grafana Labs 自家事故  | 觀測平台 + OnCall 一體化 paging |
| Grafana Cloud customer | OSS 路徑與商業 SLA 的取捨       |
