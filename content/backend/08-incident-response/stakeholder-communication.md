...
- [status page](/backend/knowledge-cards/status-page/) 比客戶在 Twitter / 社群上的回報慢（客訴作為監控失效時的補位訊號、見 [4.25 觀測共命運失效：工具退化時的訊號與人層設計](/backend/04-observability/observability-shared-fate/)）
