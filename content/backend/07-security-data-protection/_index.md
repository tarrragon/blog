...
| 拆卡試點的第二人分診比對（兩輪都由同一個人分診，對同一批列的執行者一致性未測；異源冷讀那一半已完成、結論見 [#262 的冷讀結果段](/report/content-pressure-resolves-by-expansion-not-compression/#冷讀結果翻轉點在程序消耗的列舉)）                                                                                                                                                                                                                                                                       | 主章   | 無（對象與協議都已確定）                               | 小          |
