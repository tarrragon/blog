...
| 例外紀錄的四份分解收斂（7.22 改寫前自列四項：期限 / 補償控制 / 回收條件 / owner——第四套由第二人分診抓到；7.14 分五個責任：決策 / 期限 / 補償 / 觸發 / 關閉；7.17 分六個欄位：風險範圍 / 到期日 / 補償控制 / owner / 關閉條件 / 回寫目標；`security-exception` 卡的設計責任段持有與 7.17 字面相同的第三份，而 7.14 沒有連那張卡。雙向對映兩側各有單側成員——tripwire 不在 7.17 的六欄位裡、關閉條件不在 7.14 的五責任裡（在該章判讀流程第二步）。依 [#263](/report/incompatible-decompositions-look-complementary/) 收斂：卡層是載體候選，兩章沿用卡的欄位、各自只留自己的判讀） | 主章   | 無（判準與載體選法已定）                               | 小          |
| 交接欄位的三套分解收斂（7.21 的 routing sheet、7.8 的六項交接模板、7.B1 的 Handoff target 加 Write-back target——同一個「交接要填什麼」在三處各有一套。由第二人分診比對抓到：第一位在該列判了「換成連結」因為目的地存在，但沒有比對目的地的分解。依 [#263](/report/incompatible-decompositions-look-complementary/) 選載體，7.8 是模組路由的定義處、候選載體）                                                                                                                                                                                                                  | 主章   | 無（三處的分解已盤點）                                 | 小          |
