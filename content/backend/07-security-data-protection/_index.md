...
| [7.27](/backend/07-security-data-protection/credential-rotation-scoped-evidence/)                                                           | Credential Rotation with Scoped Evidence 實作示範 | 以 webhook/API credential 輪替示範 scope map、證據欄位與回退窗口 |
