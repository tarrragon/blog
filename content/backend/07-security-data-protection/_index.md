...
| 例外協議的兩套分解收斂（7.14 分五個責任：決策 / 期限 / 補償 / 觸發 / 關閉；7.17 分六個欄位：風險範圍 / 到期日 / 補償控制 / owner / 關閉條件 / 回寫目標。雙向對映只有「關閉條件」單側存在——照 7.14 填不會產出可驗收的關閉條件。依 [#263](/report/incompatible-decompositions-look-complementary/) 選單一載體、另一篇沿用其語彙並重新界定 scope） | 主章   | 無（判準與載體選法已定）                               | 小          |
