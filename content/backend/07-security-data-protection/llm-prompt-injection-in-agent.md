...
5. **agent credential 應 per-call 簽發**：靜態 credential 影響面太大、production 應該用 [workload identity](/backend/knowledge-cards/workload-identity/)（見 [7.10 Workload Identity 與聯邦信任邊界](/backend/07-security-data-protection/workload-identity-and-federated-trust/)）動態簽發。
