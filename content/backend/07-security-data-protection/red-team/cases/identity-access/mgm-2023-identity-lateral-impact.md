...
- 發布前：定義關鍵能力的 [degradation](/backend/knowledge-cards/degradation/) 路徑。
- 日常：演練 [failover](/backend/knowledge-cards/failover/) 與回復時序。
- 事故中：依 [incident severity](/backend/knowledge-cards/incident-severity/) 快速分級與跨團隊指揮。
