...
2. Control evidence：release gate、rollback、[token revocation](/backend/knowledge-cards/token-revocation/) 操作記錄。
...
2. 供應鏈場景：檢查 artifact provenance、release freeze、[tripwire](/backend/knowledge-cards/tripwire/) 與放行條件。
