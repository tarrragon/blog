...
| 案例                                                                                                                                                                  | 跟 AWS IAM 的關係                                                                                                                       |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- |
| [Microsoft Storm-0558 Signing Key 2023](/backend/07-security-data-protection/cases/microsoft-storm-0558-signing-key-2023/)                                            | 雖是 Azure 事件、對 AWS *cross-account role assumption signing chain* 提供對照：ExternalID 設計、HSM-bound key、跨帳號 token 驗證一致性 |
