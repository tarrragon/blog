...
| 案例                                                                                                           | 先看章節                                                                                                               | 回寫目標                                                         |
| -------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------- |
| [2.C1 Meta：Cache Consistency 升級](/backend/02-cache-redis/cases/meta-cache-consistency-upgrade/)             | [2.7](/backend/02-cache-redis/cache-copy-freshness-boundary/)、[2.2](/backend/02-cache-redis/cache-aside/)             | 把 invalidation 問題前移到訊號治理 + mutation tracing            |
| [2.C2 Meta：mcrouter 跨區路由](/backend/02-cache-redis/cases/meta-mcrouter-global-cache-routing/)              | [2.1](/backend/02-cache-redis/high-concurrency-access/)、[2.7](/backend/02-cache-redis/cache-copy-freshness-boundary/) | 把快取路由層納入可用性邊界、跨區一致性窗口設計                   |
| [2.C3 Shopify：序列化遷移](/backend/02-cache-redis/cases/shopify-cache-serialization-migration/)               | [2.9](/backend/02-cache-redis/cache-migration-stampede-rollback/)、[2.2](/backend/02-cache-redis/cache-aside/)         | 把格式轉換做成雙軌相容與可回退流程                               |
| [2.C4 Meta：CacheLib / Kangaroo 分層快取](/backend/02-cache-redis/cases/meta-cachelib-kangaroo-tiered-cache/)  | [2.3](/backend/02-cache-redis/ttl-eviction/)                                                                           | 分層 cache 容量跟成本曲線（DRAM / flash / 持久 KV）              |
| [2.C5 Shopify：Write-through Cache](/backend/02-cache-redis/cases/shopify-write-through-cache-at-scale/)       | [2.2](/backend/02-cache-redis/cache-aside/)                                                                            | cache aside / write-through / write-behind 選擇條件              |
| [2.C6 Netflix：EVCache 全域快取層](/backend/02-cache-redis/cases/netflix-evcache-global-cache-layer/)          | [2.7](/backend/02-cache-redis/cache-copy-freshness-boundary/)、[2.1](/backend/02-cache-redis/high-concurrency-access/) | cache 成為跨區資料層、平台層基礎設施                             |
| [2.C7 Cloudflare：Cache Reserve 分層](/backend/02-cache-redis/cases/cloudflare-cache-reserve-tiered-storage/)  | [2.3](/backend/02-cache-redis/ttl-eviction/)                                                                           | edge + persistent reserve 的長尾命中率設計                       |
| [2.C8 Meta：TAO 社交圖快取演進](/backend/02-cache-redis/cases/meta-tao-social-graph-cache-evolution/)          | [2.1](/backend/02-cache-redis/high-concurrency-access/)、[2.7](/backend/02-cache-redis/cache-copy-freshness-boundary/) | cache 變資料層能力、資料模型治理                                 |
| [9.C6 Tinder：ElastiCache 47M MAU](/backend/09-performance-capacity/cases/tinder-elasticache-valkey-matching/) | [2.1](/backend/02-cache-redis/high-concurrency-access/)、[2.7](/backend/02-cache-redis/cache-copy-freshness-boundary/) | cache 是主要服務面、sustained growth 成本曲線                    |
| [9.C25 Tubi：ML feature store](/backend/09-performance-capacity/cases/tubi-elasticache-ml-feature-store/)      | [2.8](/backend/02-cache-redis/cache-data-shape-access-pattern/)、[2.2](/backend/02-cache-redis/cache-aside/)           | ML feature store 三層 cache 設計、cache vs persistent store 取捨 |
| [9.C35 Snap：KeyDB cross-cloud](/backend/09-performance-capacity/cases/snap-gcp-keydb-cross-cloud/)            | [2.1](/backend/02-cache-redis/high-concurrency-access/)、[2.7](/backend/02-cache-redis/cache-copy-freshness-boundary/) | KeyDB multi-threaded fork、跨 cloud 部署資料引力                 |
