...
| ----------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Redis](redis/)                     | [memory-eviction-tuning](redis/memory-eviction-tuning/) / [persistence-fork-latency](redis/persistence-fork-latency/) / [sentinel-ha-failover](redis/sentinel-ha-failover/) / [connection-pipeline-latency](redis/connection-pipeline-latency/) / [cluster-resharding](redis/cluster-resharding/) | [→ Valkey](redis/migrate-to-valkey/) / [→ DragonflyDB](redis/migrate-to-dragonflydb/) / [→ Memcached](redis/migrate-to-memcached/) / [→ ElastiCache](redis/migrate-to-elasticache/) |
| [Valkey](valkey/)                   | [redis-compatibility-and-io-threads](valkey/redis-compatibility-and-io-threads/)                                                                                                                                                                                                                  | （沿用 Redis → ElastiCache：自管 Valkey 同路徑）                                                                                                                                    |
| [Memcached](memcached/)             | [slab-allocator-memory-economics](memcached/slab-allocator-memory-economics/)                                                                                                                                                                                                                     | [→ Redis](memcached/migrate-to-redis/)                                                                                                                                              |
| [DragonflyDB](dragonflydb/)         | [shared-nothing-multicore-architecture](dragonflydb/shared-nothing-multicore-architecture/)                                                                                                                                                                                                       | [→ Redis/Valkey](dragonflydb/migrate-to-redis/)                                                                                                                                     |
| [AWS ElastiCache](aws-elasticache/) | [managed-responsibility-boundary](aws-elasticache/managed-responsibility-boundary/)                                                                                                                                                                                                               | [→ 自管 Redis/Valkey](aws-elasticache/migrate-to-self-managed/)                                                                                                                     |
| [KeyDB](keydb/)                     | [active-active-replication](keydb/active-active-replication/)                                                                                                                                                                                                                                     | [→ Redis/Valkey](keydb/migrate-to-redis/)                                                                                                                                           |
