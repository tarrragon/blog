...
Request Routing 位在 client、[API Gateway](/backend/knowledge-cards/api-gateway/)、[Load Balancer](/backend/knowledge-cards/load-balancer/) 與 application 之間。它通常依 host、path、header、method、tenant、版本或地區決定流量走向。
