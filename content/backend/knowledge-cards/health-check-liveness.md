...
date: 2026-04-23
description: "說明平台如何判斷 process 是否仍然存活，以及它和 readiness 的差異"
weight: 31
---

Health check / liveness 的核心概念是「判斷 instance 是否仍能維持基本存活」。平台用這類訊號決定是否重啟 instance；readiness 則決定 instance 是否接收正式流量。
...
Health check 要簡單、穩定、成本低。Runbook 應說明 liveness fail 代表什麼、平台何時重啟、重啟後如何觀察 crash loop 與資源限制。
