...
Internal Endpoint 位在 service discovery、internal network、[API Gateway](api-gateway/) 與 application 之間，並可能受到 [Request Routing](request-routing/) 影響。它通常依賴封閉網段、服務身份與內部流量控制。
