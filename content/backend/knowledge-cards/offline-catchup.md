...
Offline catch-up 常出現在 WebSocket、mobile push 與跨區域同步。即時通道只負責在線時低延遲傳遞，離線後的完整性通常由 [durable queue](/backend/knowledge-cards/durable-queue/)、event log 或資料庫狀態查詢提供。
