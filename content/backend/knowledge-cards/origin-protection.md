...
date: 2026-07-20
description: "說明快取如何治理 miss 事件，避免壓力集中打回正式來源或下游服務"
weight: 390
...
Origin protection 位在快取層與 [source of truth](/backend/knowledge-cards/source-of-truth/) 之間，責任是把「快取失效」跟「回源流量失控」這兩件事解耦。快取原本用來保護資料庫，若熱門資料同時過期或大量查詢命中不存在的 key，快取反而會把大量請求集中送到資料庫——origin protection 就是防止這個反轉發生的整套手段。
