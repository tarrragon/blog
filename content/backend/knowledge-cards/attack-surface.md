...
Attack surface 是紅隊分析的起點。它回答「哪裡先被看到」，因此會和 [Public API](../public-api-endpoint/)、[Admin Endpoint](../admin-endpoint/)、[Diagnostic Endpoint](../diagnostic-endpoint/)、[Internal Endpoint](../internal-endpoint/)、[webhook](../webhook/) 與 [Security Misconfiguration](../security-misconfiguration/) 一起被檢查。
