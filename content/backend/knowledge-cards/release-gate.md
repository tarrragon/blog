...
Release Gate 位在 migration、schema change、deployment、error budget 與 incident policy 之間。它把驗證結果轉成可執行的放行決策，並常搭配 [Rollback Rehearsal](/backend/knowledge-cards/rollback-rehearsal/) 確認放行前後都能回復。
