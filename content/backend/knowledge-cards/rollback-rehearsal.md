...
Rollback Rehearsal 位在 release gate、rollback strategy、migration 與 disaster recovery 之間。它是把回滾步驟實際走過一次的演練，文件審查無法替代實機驗證。 可先對照 [Rollback Strategy](/backend/knowledge-cards/rollback-strategy/)。
