...
Graceful shutdown 要搭配 timeout、[draining](draining/)、[idle timeout](idle-timeout/)、idempotency 與觀測訊號。Runbook 應能看到停止期間的 in-flight request、consumer ack、長連線數、錯誤率與強制終止次數，讓部署問題可以被定位。
