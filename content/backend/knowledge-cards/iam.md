...
IAM 位在 authentication、authorization 與組織治理之間。它常與 [authentication](../authentication/)、[authorization](../authorization/) 與 [least privilege](../least-privilege/) 一起出現，也會影響 tenant boundary 與 service account 管理。
