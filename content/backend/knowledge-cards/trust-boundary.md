...
Trust boundary 會出現在 [authentication](../authentication/)、[authorization](../authorization/)、[tenant boundary](../tenant-boundary/)、[TLS / mTLS](../tls-mtls/)、[SSRF](../ssrf/) 與 network policy 交界。它不是單一防護，而是描述「哪裡開始需要重新驗證」的分析框架。
