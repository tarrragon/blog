...
[REST 流派總覽](/backend/11-api-design/styles/rest/)（REST 原義與這個詞的選型用法）、[11.3 資源建模](/backend/11-api-design/resource-modeling-operation-semantics/)（representation 概念來源、已引用）。
