...
[公開 API 的 GraphQL 進退](/backend/11-api-design/styles/graphql/graphql-public-api-tradeoffs/)（anchor、已引用）、11.2 風格選型（共存段、已引用）。Shopify cluster（與 C24 graphql-batch 相關）。
