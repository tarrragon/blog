...
> 本文是 [OpenTelemetry](/backend/04-observability/vendors/opentelemetry/) 的 vendor deep article，深化 overview「Collector 部署模式」段。初次接觸 OpenTelemetry 的讀者建議先讀 [OpenTelemetry 服務頁](/backend/04-observability/vendors/opentelemetry/)，再回到本文。指令於 2026-06-16 用 `otel/opentelemetry-collector-contrib:0.154.0` 在 docker 實機驗證。
