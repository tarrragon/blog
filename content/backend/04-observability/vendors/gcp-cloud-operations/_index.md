...
- 對應 [4.C5 Cloud Trace OTLP](/backend/04-observability/cases/cloud-trace-otlp-adoption/)
...
- 對應 [4.C5 Cloud Trace OTLP adoption](/backend/04-observability/cases/cloud-trace-otlp-adoption/)
- 跟 X-Ray 比、distributed tracing 較基礎

## Deep Article

- [Cloud Monitoring Metrics Model 與 MQL](cloud-monitoring-mql/)：GCP metrics model、MQL vs PromQL、custom metrics 設計、alerting policy 與 Managed Prometheus 整合
- [Cloud Logging 查詢、匯出與合規](cloud-logging-export-compliance/)：查詢語言、log router / sink 匯出、retention 設計、organization-level 聚合、audit log 與 PII / CMEK 合規治理
...
| 案例                                                                                | 主討論議題             |
| ----------------------------------------------------------------------------------- | ---------------------- |
| [4.C5 Cloud Trace OTLP](/backend/04-observability/cases/cloud-trace-otlp-adoption/) | OTLP 在 GCP 的採用路徑 |

### 跨 vendor 對照

| 案例                                                                                                       | 對 Cloud Operations 的對應                      |
| ---------------------------------------------------------------------------------------------------------- | ----------------------------------------------- |
| [4.C1 Fintech audit](/backend/04-observability/cases/fintech-audit-evidence-observability/)                | Cloud Logging + BigQuery 作為審計證據與長期分析 |
| [4.C3 Healthcare retention](/backend/04-observability/cases/healthcare-access-traceability-and-retention/) | BigQuery 匯出長期 retention                     |
| [4.C9 OTel migration signal drift](/backend/04-observability/cases/failure-otel-migration-signal-drift/)   | （反例）Cloud Trace ↔ OTLP 雙軌語意對齊         |
