...
進度（2026-06-22）：9 個 T1 vendor 中 8 個已有 deep article（共 19 篇）。Datadog 與 Grafana Stack 目前只有 migration playbook、尚未開 deep article。OpenTelemetry 後續候選：Sampling 策略 / Auto-instrumentation。各 vendor 進階主題的更多 deep article 見各自 `_index.md` 的「預計實作話題」段。
