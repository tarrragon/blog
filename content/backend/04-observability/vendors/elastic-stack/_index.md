...
- 對應 [4.C4 ADOT EKS](/backend/04-observability/cases/adot-eks-observability-pipeline-migration/) 對照
...
| 案例                                                                                                       | 主討論議題                  |
| ---------------------------------------------------------------------------------------------------------- | --------------------------- |
| [4.C6 Healthcare retention](/backend/04-observability/cases/healthcare-access-traceability-and-retention/) | Index Lifecycle / retention |
