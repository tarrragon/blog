...
- [Index Lifecycle Management 與 Log Pipeline](ilm-log-pipeline/)：ILM policy 設計、data stream / rollover、Beats vs Elastic Agent 採集選擇、ingest pipeline 與 shard sizing、cost governance

## Migration Playbook

- [Elastic Cloud 遷移](migrate-to-elastic-cloud/)：自管 Elastic Stack 遷移到 Elastic Cloud
