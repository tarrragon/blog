...
可觀測性模組的核心目標是說明服務如何把 [log schema](../knowledge-cards/log-schema/)、[metrics](../knowledge-cards/metrics/) 與 [trace context](../knowledge-cards/trace-context/) 轉成可操作的診斷系統。語言教材會處理標準 logger、runtime 訊號、diagnostics endpoint 與 trace context 邊界；本模組負責平台、資料流與操作規則。
