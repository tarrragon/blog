...
draft: false
description: "第一次用 Hugo + Bear Cub 從零架站、或部落格社群分享卡片的中文變問號、想設文章摘要與「繼續閱讀」、要接 GitHub Pages 自動部署時回來照抄。含 hugo.toml 多語言設定、social_card.html 換思源黑體修中文亂碼、摘要三層優先序、deploy workflow。"
