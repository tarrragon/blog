...
1. **Clean Architecture 實作方法論**
   - 路徑：`clean-architecture-implementation.md`
   - 內容：五層架構實作細節

2. **TDD 四階段流程**
   - 路徑：`tdd-collaboration-flow.md`
   - 內容：Phase 1-4 詳細流程

3. **Ticket 設計方法論**
   - 路徑：`ticket-design-methodology.md`
   - 內容：Ticket 寫作規範

4. **5W1H 自覺決策方法論**
   - 路徑：`5w1h-self-awareness-methodology.md`
   - 內容：決策框架和逃避行為檢測

5. **敏捷重構方法論**
   - 路徑：`agile-refactor-methodology.md`
   - 內容：代理人分工協作模式
