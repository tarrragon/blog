...
- → [Terraform CI Pipeline 設定指南](/infra/07-infra-as-pr/terraform-ci-pipeline-setup/)：GitHub Actions 完整 workflow
- → [checkov 與 tfsec 規則配置](/infra/07-infra-as-pr/checkov-tfsec-rule-customization/)：規則選擇、豁免管理、CI 整合
