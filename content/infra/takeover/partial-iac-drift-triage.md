...
- → [State 修復與清理](/infra/takeover/partial-iac-state-repair/)：drift 處理前先確認 state 本身是健康的
- → [Unmanaged resource 批次 import](/infra/takeover/partial-iac-bulk-import/)：drift 收斂完成後，開始 import unmanaged resource
