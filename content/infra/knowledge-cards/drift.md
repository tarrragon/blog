...
Drift 是 Console 唯讀鐵律存在的根本理由。[模組一：Console 唯讀鐵律](/infra/01-minimal-iac/console-readonly-minimal-viable/)用權限機制（人類身分唯讀、寫入權限留給自動化身分）讓「在 Console 改不動」成為預設狀態，從源頭消除 drift 的產生。
