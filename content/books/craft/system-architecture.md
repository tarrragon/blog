...
證據來源是兩位作者的顧問與教學經驗加上業界案例整理，形式接近教科書——它整理已知的做法而非提出新主張，這也決定了它的用法：當參照系用，不是當論證用。處境上，架構特性的取捨預設有人為不同特性負責、而且那些人講得上話。決定由外部給定時——客戶指定、母公司統一、法規要求——這本書給的是理解那個決定的語言，不是做那個決定的方法。讀得出價值的前提是：參與過一個需要跨團隊協調的系統——只在單一服務裡工作時，架構特性的衝突體會不到，因為衝突要在有人為不同特性負責時才顯現。
