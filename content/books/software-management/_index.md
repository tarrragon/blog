...
| 項目                       | 類型 | 前置條件                                                                                                                                                                                                                                                                    | 規模 |
| -------------------------- | ---- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---- |
| 十個主題各跑一次機制式搜尋 | 案例 | 機制詞候選事前寫死在 [主題書單的公開課段](topics/#沒查到課的那十個主題理由分三種)（研究設計與因果推論 / 承諾可信度 / 訊號傳遞 / 集體決策 / 因果回路與存量流量），前置條件是先把第三組那五個主題的機制詞想出來（目前只有五個詞、覆蓋前兩組），產物是十組詞各查到什麼，可重跑 | 1 次 |
| 沒查到課的十個主題重掃一次 | 案例 | 2027 年 8 月之後重跑，判斷標準是本質恆定加實際有影音；是哪十個主題與各自為什麼空，見 [主題書單的公開課段](topics/#沒查到課的那十個主題理由分三種)                                                                                                                           | 1 次 |
