...
三門課教的都是推導而非當期材料，時效因此不隨年代改變；ECON 159 錄於 2007 年，它舉的產業例子（外包、教育訊號）屬於當時的情境，推導本身不依賴那些例子。台大那兩門的取得限制寫在本節的 Coursera 那一段。整條線的供給狀況寫在 [主題書單的公開課段](../#沒查到課的那些主題理由分三種)。
...
一個日期是承諾還是意向，這件事本身隨對方的成長環境改變，而這個主題的書幾乎都預設它是承諾。跨國專案裡期限反覆對不上時先查這一項，走 [跨文化協作與行為判讀](../cross-cultural-collaboration/)。
