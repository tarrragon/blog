...
這組判準同時適用管理線十一篇與技藝線四篇。目前十五篇的起點書全部在第一層就定案——涵蓋面拉開差距時，後兩層不會被走到，用它們解釋落選是把判準倒過來套。第二、三層是為將來出現真正並列的情況預留的。唯一的例外是技藝線的驗證那篇，它取 Beck 的理由是後面兩本都在跟它對話，那條判準不在這三層裡，就地登記為例外。
