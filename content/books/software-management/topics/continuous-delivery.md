...
這個主題處理「怎麼知道一個做法真的有效」。軟體業長期靠資深者的經驗談傳遞判斷，而經驗談無法區分「這個做法有效」與「做這件事的那個人很強」。這個主題的書按證據強度分成三層——大規模實證、跨組織案例、單一組織的制度紀錄——三層能支撐的決定重量不同，用錯層會在說服別人時失效。
...
它的性質要說清楚：所有結論都由劇情推出來，沒有資料支撐。這使它適合拿給不讀技術書的主管或跨部門同事建立共同語言，不適合當作論證的依據。這也是它沒有被選為起點書的原因——涵蓋面排在 Accelerate 之後，第一層就分出勝負。但它是本篇唯一不需要任何前置經驗就讀得下去的一本。
...
這一卷跟《Accelerate》的關係是互補而非替代。《Accelerate》回答該量什麼並提供統計支撐，這一卷回答量測制度在人身上會產生什麼副作用——後者沒有大規模實證，但這條線的其他書也沒有處理這個副作用。
