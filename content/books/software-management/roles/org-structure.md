...
這是 [依位置選書](../which-position/#五個位置) 五個責任範圍裡最外面的一個：管的是管人的人，不再是人本身。因此動作與結果之間隔著至少兩層，回饋延遲以季為單位——這個位置的判斷幾乎都要在確認得到結果之前就下。要判斷的東西落在團隊與團隊之間：邊界畫在哪、交接面誰負責、哪些事情沒有人特別該負責但一定會出問題。
