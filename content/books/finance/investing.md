...
先拿哪一本，看現在要決定什麼。還沒有配置、或不確定主動選股值不值得投入，從 [《漫步華爾街》](#起點是漫步華爾街) 開始，它是這裡唯一零基礎讀得動、而且配置與選擇兩層都處理的一本。已經在配置而想知道自己用的報酬假設合不合理，走 [Triumph of the Optimists 與 Expected Returns](#要知道報酬數字本來長什麼樣時讀-triumph-of-the-optimists-與-expected-returns)。決定要逐檔挑，那需要的是估值紀律，走 [《智慧型投資人》](#智慧型投資人跟漫步華爾街的前提相反)——它跟起點書的前提相反，兩邊都看過再選一邊。
