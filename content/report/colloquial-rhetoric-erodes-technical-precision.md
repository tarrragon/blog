...
date: 2026-05-06
weight: 111
description: "技術文章用「一輩子」「碰巧能用」「立刻撞牆」「沒事」這類口語修辭、會在三個層次稀釋精度：時間性誇張（「一輩子」混淆 lifecycle / 任意時序）、因果模糊（「碰巧」遮蔽機制論證）、結局描述代替契約描述（「撞牆」描述事件、不描述限制條件）。修法是把口語修辭翻譯回技術屬性語言（生命週期 / 觸發條件 / 型別契約 / 違反條件）。"
tags: ["report", "事後檢討", "工程方法論", "原則", "寫作"]
---

## 核心原則

技術文章的精度來自**用詞選擇能不能對應到具體技術屬性**。口語修辭（「一輩子」「碰巧」「立刻撞牆」「沒事」）讀起來流暢、但會在三個層次稀釋精度：
