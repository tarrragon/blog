---
title: "Pattern：誠實進度 UX（已掃 N / 命中 K / 共 M）"
date: 2026-04-26
weight: 62
description: "Pattern 卡片：當 filter 跟 source 必然有層錯位、用三數字（已掃 N / 命中 K / 共 M）讓使用者看見掃描範圍、避免誤以為「沒命中」。對應 #59 策略 D 的具體實作。"
tags: ["report", "Pattern", "工程方法論", "UX"]
---
...
對應 #59 [Filter × Source 合成策略](../filter-source-composition-strategies/) 的策略 D。
...
誠實進度 UX 是 #57 [Loading / Empty / End 三狀態的區分](../loading-empty-end-state-distinction/) 在「filter + 分批」情境下的具體實作。三數字提供區分三狀態的訊號：
