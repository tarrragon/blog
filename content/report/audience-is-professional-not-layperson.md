...
- **可信度損失**：工程師讀到「你可能不知道」時，如果他其實知道（只是沒做過），教材在他心中的權威性立刻下降。一旦開頭失去信任，後面的技術判斷標準也會被打折。
...
- [#341 讀者定位擋住科普化的同一句話，供應了省略解釋的理由](../audience-level-licenses-omission/)：限定本卡，並把 #305 那一條的機制寫出來。本卡的定位宣稱是**能力**宣稱（讀者有能力理解），而它在寫作當下被讀成**知識**宣稱（讀者已經知道）——同一句話對兩種讀法都通順，而只有後一種會授權省略基本名詞、原理與知識卡。單獨讀本卡會拿到半條規則：它擋住了把讀者當外行人，同時供應了「讀者不需要這個解釋」最有力的依據。兩種違規在稿件上長得相反，掃本卡的那一輪不會順便抓到它。
