...
問題出在下一步。推翻之後我立刻換上新結論：「弱強不是作用中的變因，抽取式協議才是。」再一次 WARP 才發現——**十一個受測者全部跑抽取式協議，沒有任何一個跑評價式**。新結論的證據狀態，跟舊結論被推翻之前完全相同：一個聽起來合理的故事、幾個 finding、零對照。我在同一段工作裡，用剛剛才驗證過有效的批評，換上了一個經不起同一個批評的替代品。
