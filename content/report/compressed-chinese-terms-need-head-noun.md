...
| [#339 壓縮標籤省下的字數是一次，展開成本乘以引用點數](../compressed-label-cost-multiplies-with-citations/) | 互補的另一種壓縮：本卡管名詞頭被砍，#339 管名詞頭健在而限定語被砍。本卡的四道檢查對那種形態全數放行，因為它讀起來是完整的詞。                          |
| [#261 語句要在它的消費單位內資訊自足](../sentence-self-sufficiency-by-consumption-unit/)                   | 本卡的名詞頭義務被 #261 推廣到整句：術語壓縮後要能回答「這是什麼」、句子壓縮後要能回答「誰、對什麼、什麼條件」——單句消費位的四條件是同一義務的句層版。 |
