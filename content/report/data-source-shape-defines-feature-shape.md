...
- **實際發生的代價**：撞上 [#55 層錯位](../view-layer-filter-vs-source-layer/)、長期維護負擔大（每次 source 升級都要重 patch）、使用者信任損失
...
「形狀的可改造性」三類跟 [#1 在外部組件上加客製功能](../external-component-customization/) 共骨：兩者都是「先看你能改什麼、再決定怎麼客製」。#1 講的是 UI 客製、本卡講的是資料層客製、共同精神是「客製從邊界往中心做、不要倒推」。
