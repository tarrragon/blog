...
**Last Updated**: 2026-07-20 — 新增 #229-#231 分析文章結構三卡（從八方雲集案例分析的引言修訂和 SRP 拆分抽出）：#229 分析開頭定位問題不講創辦敘事、#230 寫作動機是編輯資訊不屬正文、#231 案例文章跟跨公司比較是兩個分析責任（拆分後案例深化 + 比較篇可擴充）。新增路徑 34 串 #229 / #230 / #170 / #141（讀者 surface 不放編輯 metadata）。
