...
**Last Updated**: 2026-07-20 — 新增 #232 自審偵測方法要對齊規則類型、#233 知識卡的缺孤錯住在卡↔文章關係裡（都從本 session 多輪審查 Round 3 抽出：#232 是 grep self-sweep 對無關鍵詞規則失明、#233 是缺卡 / 孤兒 / 矛盾三種缺陷住在卡↔文章的邊上、要消費側 audit 才看得見、由 outbound frame 抓到兩缺卡 + CDP 矛盾）；路徑 35 串 #232 / #233 / #221 / #165 / #147（通過訊號先問涵蓋、audit 立足點限制可見範圍）。前次：新增 #229-#231 分析文章結構三卡、路徑 34 串 #229 / #230 / #170 / #141。
