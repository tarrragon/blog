...
這張表是 #355 之後的卡，尚未併進上面的篇目索引——那裡每一條帶一段判讀敘述，這裡只有標題與類型，兩者的體例不同，合併要逐張補敘述。

| 編號 | 標題                                                                                                                         | 類型 |
| ---- | ---------------------------------------------------------------------------------------------------------------------------- | ---- |
| #355 | [教學定位被讀成教室講課，產出的是經營注意力的障礙而非有序的說明](/report/teaching-is-not-lecturing/)                         | 寫作 |
...
| #360 | [示範指令的引數要說明，寫成字面值的那些最不像需要說明](/report/literal-operand-hides-the-change-point/)                      | 寫作 |
| #361 | [並排多種做法時，比較的軸要落在讀者接下來要交出的那份產出上](/report/comparison-axis-comes-from-the-readers-decision/)       | 寫作 |
| #362 | [規範指定了某個位置要交付什麼，全批長成同一個模板時沒有任何一道檢查管得到](/report/mandated-section-hides-its-own-sameness/) | 審查 |
