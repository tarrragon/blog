...
**Last Updated**: 2026-07-20 — 新增 #229-#230 分析文章引言功能定位雙卡（從八方雲集案例分析的引言兩輪修訂抽出）：#229 分析開頭定位問題不講創辦敘事（品牌故事設定錯誤 register、延遲讀者判斷）、#230 寫作動機是編輯資訊不屬正文（系列覆蓋缺口是編輯 metadata、讀者不在乎）。新增路徑 34 串 #229 / #230 / #170 / #141（讀者 surface 不放編輯 metadata 的四個 surface 守則）。
