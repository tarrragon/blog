...
更上位的「為什麼跳過」解釋見 [#72 高 ROI 無外部觸發的工作會被結構性跳過](../external-trigger-for-high-roi-work/) — 本卡的 Checkpoint 1 + Ship 前是 #72 在「驗收動作」面向的展現、修法（外化觸發到 PR template / CI / pair）對應 #72 的 L3-L5 對策。
