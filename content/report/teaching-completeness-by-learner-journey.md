...
| Prepare      | 若後續新增章節後只能列出內容清單、列不出 3-5 條讀者路線，代表教材設計仍在素材整理階段。 |
...
學習路線要有完成條件。只列「讀 A、讀 B、讀 C」仍像目錄；加上「讀完能判斷什麼」才是教學設計。
...
| 讀者需要自己判斷先看主章、案例還是 vendor | 補起點與完成條件             |
| 章節很多但沒有「讀完能做什麼」            | 補每條路線的學習成果         |
| 新增內容多集中在 backlog，而非導讀        | 暫停新增素材，先整理 routing |
| 對照成熟教材時，只能對到目錄，對不到旅程  | 教學設計尚未完成             |

**核心原則**：教材完整性由讀者旅程驗證，內容覆蓋率只是一個輸入。成熟教材能讓不同目的的讀者找到起點、順序與完成條件；內容地圖服務查閱，讀者旅程服務學習。
