...
本卡的建卡判準是**教學需求、不是出現頻率**（對應 AGENTS §3：建卡看「讀者缺這個知識會不會難以理解教材」、出現頻率只是補充訊號）。具體限制：
...
建卡的正當性來自**教學需求**、不是這篇的頻率：自評誇飾在技術寫作裡是常見 pattern、讀者 / 作者都容易把「verdict 讀起來有說服力」誤當「理由講清楚了」。這篇只有 1 個實例、但 pattern 普遍 —— 對應 AGENTS §3「建卡看教學需求、出現頻率只是補充訊號」。
