...
本章先聚焦單一 Go process 內的 channel close 與 goroutine lifecycle；跨 process 的 [ack](../../../backend/knowledge-cards/ack-nack/)、[[consumer](../../../backend/knowledge-cards/consumer/) group](../../backend/knowledge-cards/consumer-group) 與分散式訊號，會在下列章節再往外延伸：
