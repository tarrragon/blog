...
資料庫整合的核心責任是讓持久化行為符合 application 的狀態規則。Repository port 決定 usecase 需要哪些資料能力；[transaction boundary](../../backend/knowledge-cards/transaction-boundary/)、[schema migration](../../backend/knowledge-cards/schema-migration/) 與 [isolation level](../../backend/knowledge-cards/isolation-level/) 則決定這些能力在資料庫中如何保持一致。
