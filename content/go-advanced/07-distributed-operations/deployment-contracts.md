...
部署平台合約的核心責任是讓 Go 服務的生命週期和外部調度系統對齊。程式內部需要清楚的 context、shutdown timeout、[readiness](../../backend/00-knowledge-cards/readiness/)、[health / liveness](../../backend/00-knowledge-cards/health-check-liveness/) 與 memory limit；Kubernetes、systemd、load balancer 或雲端平台則決定這些訊號何時被觸發與如何被解讀。

## 本章目標

學完本章後，你將能夠：

1. 理解 shutdown、readiness 與 connection draining 的順序
...
- [Backend：Graceful Shutdown](../../backend/00-knowledge-cards/graceful-shutdown/)
- [Backend：Failover](../../backend/00-knowledge-cards/failover/)
