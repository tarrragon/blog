...
本章不處理完整授權模型、topic ACL、跨節點訂閱同步或 presence 系統。這些都可以建立在 action envelope、router、subscription owner 的基礎之上；後續可接 [跨節點 WebSocket、presence 與重連協定](../07-distributed-operations/cross-node-websocket/)。
