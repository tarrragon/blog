...
Base model 跟 [instruction-tuned](/llm/knowledge-cards/instruction-tuned/) model 共用底層權重結構、差別在後續微調階段。對寫 code 場景的多數使用者來說、預設選 instruction-tuned 版本；base model 主要服務想自己微調的研究人員與工程師。
