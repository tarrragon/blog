...
| LLM06 Excessive Agency      | [6.2 tool use 與 MCP server 的權限模型](/llm/06-security/tool-use-permission-model/) + [4.4 agent 架構](/llm/04-applications/agent-architecture/)                        | 跨原理 + 安全                                                                       |
