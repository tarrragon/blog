...
| LLM02 Sensitive Disclosure  | [6.4 跨雲端資料邊界](/llm/06-security/cross-cloud-local-data-boundary/)                                                                                                  | 加 [4.11 靜態 RAG 資安](/llm/04-applications/static-and-serverless-rag-deployment/) |
...
| LLM06 Excessive Agency      | [6.2](/llm/06-security/tool-use-permission-model/) + [4.2 agent 架構](/llm/04-applications/agent-architecture/)                                                          | 跨原理 + 安全                                                                       |
| LLM07 System Prompt Leakage | 部分（[4.12 coding agent harness](/llm/04-applications/coding-agent-harness/)）                                                                                          | M6 沒專章、屬 scaffold 設計                                                         |
| LLM08 Vector / Embedding    | 部分（[4.0 RAG](/llm/04-applications/rag-principles/) + [4.11 靜態 RAG 資安](/llm/04-applications/static-and-serverless-rag-deployment/)）                               | 跨原理 + 應用                                                                       |
| LLM09 Misinformation        | [hallucination](/llm/knowledge-cards/hallucination/) 卡 + [4.16 LLM-as-judge](/llm/04-applications/llm-as-judge/)                                                        | 跨卡 + 應用                                                                         |
| LLM10 Unbounded Consumption | 部分（[4.13 prompt caching](/llm/04-applications/prompt-caching-engineering/) + [4.11 靜態 RAG 資安 abuse](/llm/04-applications/static-and-serverless-rag-deployment/)） | M6 沒專章、屬 abuse 緩解                                                            |
