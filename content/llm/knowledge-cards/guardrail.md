...
Guardrail 不是單一工具，而是一組控制層。常見形式包含 [structured output](/llm/knowledge-cards/structured-output/)、validator、allowlist、rate limit、sandbox、human approval、eval、monitoring 與 rollback。它通常包在模型輸出與下游副作用之間。
