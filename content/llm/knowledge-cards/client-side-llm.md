...
5. **跟資安的關係**：client-side 不需要 server API key、隱私強；但模型分發鏈（CDN → browser）成為新的供應鏈面、見 [4.11 靜態 RAG deployment](/llm/04-applications/static-and-serverless-rag-deployment/) 的資安段
