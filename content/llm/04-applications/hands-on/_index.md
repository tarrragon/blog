...
| [Blog 語意搜尋從 pickle 到 production](/llm/04-applications/hands-on/blog-vector-search/)        | Storage 選型 → 實作 → 效能優化 → 四方案 benchmark  | 4.1 RAG / 4.12 embedding / 4.14 benchmarking / 4.22 storage 工程                               |
