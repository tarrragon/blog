...
[HyDE](/llm/knowledge-cards/hyde/)（[4.1 RAG 原理](/llm/04-applications/rag-principles/) 提過、這裡展開）。核心觀察：**query 跟 document 在 embedding 空間的距離、往往比 document 跟 document 之間更遠**——因為 query 是問句形態、document 是陳述形態。
