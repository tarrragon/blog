...
4. 看到 vocab_size = 262,144 vs 128,256 時、知道差異在哪。
...
Gemma 4 的 262K vocab 是現代 LLM 中較大的、目的之一是多語言支援。
...
Llama 2 的 32K vocab 對中文支援差、Llama 3 / Gemma 3 改善很多。實務影響：中文 prompt 在 Llama 2 上吃 context 多、Gemma 3 較友善。
...
- Gemma 4 31B + Gemma 4 4B：同 tokenizer、可以配對。
...
- 中文 prompt 用 Llama 2 比 Llama 3 / Gemma 3 吃 context 多。
