...
寫 code 場景優先用 instruction-tuned 通用模型（Gemma 4、Qwen3-Coder 等）、需要特化再評估 [RAG](/llm/knowledge-cards/rag/) 或 prompt engineering、最後才考慮 fine-tuning。三條路的取捨判讀見 [4.0 RAG 原理](/llm/04-applications/rag-principles/)。
