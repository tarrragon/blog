...
1. **Reasoning trace + tool result 都進 context**：context 用量爆炸快、需要 long context 模型（見 [4.11 Long context engineering](/llm/04-applications/long-context-engineering/)）
