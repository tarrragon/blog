...
文件被別人照著執行時另有一條：[rule-must-point-at-something-openable](/report/rule-must-point-at-something-openable/)——那裡給「照這一條工作，第一個動作是打開什麼」這個判準，與三種失效形態各自的修法。
