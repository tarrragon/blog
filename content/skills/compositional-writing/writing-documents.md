...
| --------------------------------------------------------- | -------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Same-directory sibling                                    | Relative path + intent                 | `See [validation rules](/skills/compositional-writing/validation/) for acceptable field values` <!-- broken-link-exempt: illustrative placeholder path, not a real sibling --> |
