---
title: "Translation Review — 文章翻譯與轉譯檢查"
date: 2026-05-04
description: "compositional-writing reference：把英文材料轉成中文、把既有文章改寫成另一種語言、檢查術語誤譯與句內邏輯對位。"
...
同一個「奇蹟」、在中譯一句日文標語時是超譯、在替自家產品寫中文標語時是誇飾修辭的正當運用。分辨能力比禁令有用：把三列混在一起、會在保真情境放行超譯、也會在創作情境誤殺有效的標語。未宣告目的的轉換、預設以保真為判準。鏈式轉換（翻譯的翻譯）漂移逐段累積、查證要回最上游的語言版本比對。量級命中是候選、判定在語意層：明示的意譯、宣告過的再創作、目標語言慣例要求的語氣調整（敬語、邀請式收尾）都合規。詳見 [rewrite-preserves-claim-intensity](/report/rewrite-preserves-claim-intensity/)。
