...
同一個「奇蹟」、在中譯一句日文標語時是超譯、在替自家產品寫中文標語時是誇飾修辭的正當運用。分辨能力比禁令有用：把三列混在一起、會在保真情境放行超譯、也會在創作情境誤殺有效的標語。未宣告目的的轉換、預設以保真為判準。鏈式轉換（翻譯的翻譯）漂移逐段累積、查證要回最上游的語言版本比對。詳見 [rewrite-preserves-claim-intensity](/report/rewrite-preserves-claim-intensity/)。
