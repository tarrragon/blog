...
詳細各維度的判讀規則跟修法、見對應 reference（writing-articles / writing-documents 等）跟 report 卡（[cadence-homogenization](/report/cadence-homogenization-in-batch-writing/) / [colloquial-rhetoric](/report/colloquial-rhetoric-erodes-technical-precision/) / [regional-terminology](/report/regional-terminology-alignment/) / [multi-pass-review-frame-granularity](/report/multi-pass-review-frame-granularity-blindspot/)）。
