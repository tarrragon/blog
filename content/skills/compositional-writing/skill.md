...
date: 2026-06-26
description: "以 Zettelkasten 為核心的寫作方法論，涵蓋程式碼註解、文件、日誌、prompt、技術文章與外部分析轉寫"
...
詳細各維度的判讀規則跟修法、見對應 reference（writing-articles / writing-documents 等）跟 report 原則卡（[cadence-homogenization](/report/cadence-homogenization-in-batch-writing/) / [colloquial-rhetoric](/report/colloquial-rhetoric-erodes-technical-precision/) / [regional-terminology](/report/regional-terminology-alignment/) / [multi-pass-review-frame-granularity](/report/multi-pass-review-frame-granularity-blindspot/) 等）。
