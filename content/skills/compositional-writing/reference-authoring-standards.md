...
背景推力是文體先驗：中文技術語料的四字節奏與對仗會把句子往「更短更順」拉、而 LLM 讀 reference 的三種模式（單行檢索、attention 稀釋、風格繼承）都對壓縮特別敏感——壓縮歧義的規範文字會生成壓縮歧義的輸出。詳見 [sentence-self-sufficiency-by-consumption-unit](/report/sentence-self-sufficiency-by-consumption-unit/)。
