...
同一條紀律用在報告的結論欄上，值有兩個。**分辨看的是這項結論的真假由什麼決定**——正面命中是在某個具體對象上量到的，真假由那個對象決定；窮舉宣稱是對一個集合的全稱陳述，真假由集合劃得對不對決定。**不要用量詞當判準**：「其餘」「只有」「全部」這些字是常見的表面訊號而不是判準，一句「這一類的成員已經列完」沒有任何量詞而它是窮舉宣稱。
