---
title: "Designing Fields Ticket 6W — 六欄位詳細範例"
date: 2026-04-24
description: "compositional-writing reference：正確 + 混淆共 12 項的六欄位範例（搭配 designing-fields 按需閱讀）。"
...
```yaml
when: "v1.2.0 發佈前（預計 2026-05-10），依賴 wave03-021 架構草案完成後即可啟動"
```

**為什麼正確**：

- 回答「什麼時候」的問題（版本截止、前置依賴）
- 條件可被驗證（檢查 wave03-021 狀態即可）
- 不混入「要做什麼」或「為什麼」
