...
| 8   | Keyword bank（換工具）                   | 跑 grep 比對固定 keyword list（口語修辭 / 廢話前綴 / 地區漂移 / 依賴 code）、不靠 reviewer 記憶——詳見 [#111 口語修辭](/report/colloquial-rhetoric-erodes-technical-precision/) + [#112 地區用語](/report/regional-terminology-alignment/) + [#113 self-contained](/report/prose-self-contained-without-code-reference/) |
