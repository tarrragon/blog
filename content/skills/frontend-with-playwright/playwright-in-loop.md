---
title: "Playwright in the Development Loop — 開發循環的三個位置"
date: 2026-04-26
description: "frontend-with-playwright reference：Playwright 三個位置（假設 / 行為 / 互動驗證）的 evaluate 範例、寫成 layout test 的時機與模板、最低門檻 setup。"
