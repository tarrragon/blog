---
title: "DOM Topology First — 寫 CSS 前先確認 DOM 結構"
date: 2026-04-26
description: "frontend-with-playwright reference：寫 CSS 前用 playwright/DevTools 量真實 DOM、selector 三維度設計、起點四選一、idempotency 兩選一。"
