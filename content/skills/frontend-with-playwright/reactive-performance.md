---
title: "Reactive Performance — Reactive 效能盤點與優化"
date: 2026-04-26
description: "frontend-with-playwright reference：MutationObserver 三維度、polling → observer、iteration / regex 成本、layout reflow、resource 載入時序、reactive listener 盤點協議。"
