---
title: "Decision Dialogue — 決策對話的五維度協議"
date: 2026-04-26
description: "requirement-protocol reference：呈現決策時的五個獨立維度（呈現格式 / 策略數 / 批次邊界 / 時間軸 / 選項類型）+ 五步判讀 + 完整套用範本 + self-check。對應 #74-#79 系列。"
...
**判斷標準**：「這次 output 該收斂到一個答案、還是攤開多面向？」
...
**判斷標準**：「我（agent）有沒有提供能讓使用者下決定的全部資訊？」
...
**判斷標準**：策略間 (1) 解不同層、(2) 沒副作用衝突、(3) 增量成本可接受 → 三條全滿足 = 該疊加。
...
- [ ] **策略數**：選項間能不能疊加？三條判斷標準（不同層 / 無衝突 / 成本可接受）滿足的話有沒有提組合？
