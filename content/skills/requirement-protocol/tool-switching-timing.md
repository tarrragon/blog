---
title: "Tool Switching Timing — 推理 / DevTools / Playwright 的切換時機"
date: 2026-04-26
description: "requirement-protocol reference：四種 debug 工具的 ROI 對照、切換訊號、playwright 三個位置（假設 / 行為 / 互動驗證）。"
