---
title: "Requirement Protocol — SKILL 入口"
date: 2026-04-26
description: "從需求確認到實作的對話協議 SKILL 入口：四大支柱（含 multi-pass refinement）、七大原則速查、六份情境 reference（含篩選類指令、決策呈現五維度）的觸發路由 + 抽象層原則網路。"
tags: ["skills", "requirement-protocol", "工程方法論", "對話協議"]
---
