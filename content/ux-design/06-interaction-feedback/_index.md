...
| [通知模式選擇](notification-pattern-selection/) | SnackBar / Dialog / Banner / Bottom Sheet 判斷標準 | 結果通知該用什麼形式呈現？   |
...
| 操作結果通知（成功 / 失敗 / 空結果呈現） | 導航模式（[模組五](/ux-design/05-navigation-patterns/)）        |
| 防重複提交（debounce 防連點 / disable）  | 表單驗證 UX（[模組三](/ux-design/03-input-mechanism/)）         |
| 感知效能技巧（skeleton / 樂觀更新）      | 無障礙宣告與可聽化（aria-live / aria-busy）                     |
