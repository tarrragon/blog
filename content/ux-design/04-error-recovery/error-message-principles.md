...
- 重試機制的 UX 設計 → [Retry 機制 UX](/ux-design/04-error-recovery/retry-mechanism-ux/)
- 錯誤狀態的退出路徑 → [error → retry → error 循環的逃生口](/ux-design/04-error-recovery/error-loop-escape/)
- 畫面狀態矩陣中的 error 狀態 → [ux-design 模組一 畫面狀態機](/ux-design/01-screen-state-machine/)
