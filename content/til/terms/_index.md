...
title: "跨領域術語"
slug: "terms"
description: "一個概念與它牽起的一組詞：同概念在不同領域的稱呼、互補概念、衍生指標。從你遇到的問題進入，再讀到具體的詞。第一組圍繞 false positive（誤報）展開"
tags: ["til", "術語", "跨領域"]
---

這個子分類收錄**一個概念與它牽起的一組詞**。和 [單字](../vocab/) 收英文字源不同，這裡關心的是：一個概念在不同領域被叫成什麼、它的互補概念與衍生指標。分的是領域；若要分的是語言與地區，那一條軸在 [料理](../cooking/)。

第一組詞圍繞「false positive（誤報）」展開。**建議從你遇到的問題進入**——下面每個議題頁會把你導向該讀的術語卡，而不是劈頭背定義：
