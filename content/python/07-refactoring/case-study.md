...
詳細的抽取過程在[配置分離與常數管理](../constants-management/)中說明。
...
把散落在各 Hook 中的硬編碼錯誤訊息提取到集中的 messages 模組。這對應的是 [配置分離與常數管理](../constants-management/) 中「禁止硬編碼字串」的原則。
...
_上一章：[非程式碼的重構](../non-code-refactoring/)_
