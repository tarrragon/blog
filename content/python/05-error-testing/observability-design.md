...
*上一章：[頂層例外處理機制](../error-infrastructure/)*
*相關：[重構陷阱與防護](../../07-refactoring/refactoring-pitfalls/) -- IMP-003/005/006 的重構角度分析*
*相關：[作用域迴歸案例研究](../../07-refactoring/scope-regression/) -- IMP-003 的完整技術分析*
