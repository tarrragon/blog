...
詳細的作用域分析見[作用域迴歸案例研究](/python/07-refactoring/scope-regression/)。
...
_上一章：[頂層例外處理機制](/python/05-error-testing/error-infrastructure/)_
_相關：[重構陷阱與防護](/python/07-refactoring/refactoring-pitfalls/) -- IMP-003/005/006 的重構角度分析_
_相關：[作用域迴歸案例研究](/python/07-refactoring/scope-regression/) -- IMP-003 的完整技術分析_
