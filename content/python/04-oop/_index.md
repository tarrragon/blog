...
| 章節                                                  | 主題           | 關鍵收穫           |
| ----------------------------------------------------- | -------------- | ------------------ |
| [4.1 類別設計原則](/python/04-oop/class-design/)      | 類別設計原則   | 設計清晰的類別介面 |
| [4.2 抽象基類 ABC](/python/04-oop/abc/)               | 抽象基類 ABC   | 定義介面契約       |
| [4.3 工廠模式](/python/04-oop/factory/)               | 工廠模式       | 動態建立物件       |
| [4.4 單例與快取模式](/python/04-oop/singleton-cache/) | 單例與快取模式 | 控制物件生命週期   |
