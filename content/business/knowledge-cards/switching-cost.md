...
Switching Cost 跟 [Lock-in](/business/knowledge-cards/lock-in/) 互為表裡，也是 [Retention](/business/knowledge-cards/retention/) 的結構性原因。它不只是金錢成本，還包括時間成本、風險成本與機會成本—換錯了可能整個業務癱瘓。對賣方來說，主動設計切換成本是長期策略；對買方來說，避免被高切換成本綁定是採購紀律。
