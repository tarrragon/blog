...
title: "Capex"
date: 2026-07-19
description: "用資本支出的方向和量級追蹤企業的真實策略意圖——錢投在哪裡比管理層說什麼更能揭示優先序"
weight: 68
...
Capex 是追蹤企業策略意圖最直接的財報工具——管理層的法說會敘事可能模糊或樂觀，但錢投在哪裡騙不了人。當一間公司口說「食品轉型」但 capex 持續加碼飼料產能，行動跟敘事不一致。跟[自由現金流](/business/knowledge-cards/free-cash-flow/)直接連動：FCF = 營業現金流 - Capex。Capex 過高會壓縮可配發的股利和可用於併購的餘裕。
...
Capex 適用於資本密集型產業（製造、零售、物流）。輕資產模式（SaaS、平台）的 capex 極低，策略意圖改看研發費用（R&D）和人力配置。另外，capex 只反映「花了多少」，不反映「回收了多少」——需要搭配產能利用率和新廠營收貢獻率做交叉判讀。
