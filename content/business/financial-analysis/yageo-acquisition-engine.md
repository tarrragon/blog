...
評估一家併購引擎型公司,管理層的資本配置能力是核心變數。國巨的管理層由創辦人兼董事長陳泰銘主導,他在併購策略上的執行力有公開紀錄支撐——25 年內完成八筆跨國併購、產品組合從單一電阻廠轉型為四品類平台,這是管理能力的證據。
...
**庫藏股與員工認股操作**。2018 年國巨以 24 億元買回 2,965 張庫藏股（均價約 816 元）,用途從「維護股東權益」改為「轉讓予員工」。2021 年的員工認股名單中,保全、司機、帳房列入前十大認購人;陳泰銘以策略投資管理委員會主委身分認購 1,719 張,認購價 38.9 元——不到當時市價的一成。同年全體股東因庫藏股註銷損失 23.9 億元（每股淨值減少 4.8 元）。

**配息與減資**。2021 年 EPS 為歷年次高,配息率僅 21%（十年新低）。2022 年 3 月,營收持續擴張期間宣布現金減資 20%。董事平均年薪酬約 7,824 萬台幣（2024 年度,台灣上市公司第二高）,員工分紅僅佔稅後淨利約 2%（同業一般在 5-10%）。

這些事件構成一個方向一致的資本操作模式——下市收購價偏低、高點關聯方出脫、庫藏股轉員工認股讓管理層低價取得股權、低配息保留現金在公司內部、營收擴張期減資——形成一個資本操作對管理層有利、對小股東不利的系統性模式。

來源:SemiMedia、TechNews、關鍵評論網、今周刊、數位時代、自由時報。公平交易委員會在搜尋範圍內未找到針對國巨 2018 年漲價行為的調查或裁罰記錄。
...
本篇是[併購引擎型公司整合效果判讀](/business/financial-analysis/acquisition-driven-integration/)方法論的實作案例——用國巨的財報數據走一遍毛利率結構改善、現金流跟進、CCC 變化、商譽累積風險四個維度。商譽減損的會計機制見[Impairment 卡片](/business/knowledge-cards/impairment/)。管理層品質在價值投資判讀中的位置見[價值投資案例回訪](/business/financial-analysis/value-investing-retrospective/)。被動元件產業是本模組首個電子業案例,跟既有的食品/零售/油品案例群在產業結構上完全不同——景氣循環更劇烈、毛利率波動更大、併購是核心成長模式而非補充手段。
