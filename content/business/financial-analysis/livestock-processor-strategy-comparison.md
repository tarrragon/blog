...
同樣在台灣做畜產加工，大成毛利率 15%、卜蜂 21%、嘉一香國內冷藏豬肉市佔 30%（未上市）、超秦 16.6%。同樣是處理動物蛋白的工廠，利潤結構差距顯著。差異不在市場環境——四間公司面對相同的飼料成本、相同的通路結構、相同的消費者。差異在策略選擇：[垂直整合](/business/knowledge-cards/vertical-integration/)要做多深、自動化投多少、品牌走什麼方向、通路怎麼控制。本篇用四間公司的公開數據，比較這四條成本控管路徑的投入邏輯和財報結果。
...
| 主力品類   | 飼料 52% + 肉品 18% + 食品 20%           | 農畜肉品 45-50% + 飼料 25-30% + 食品 20% | 豬肉（冷藏/冷凍市佔 ~30%）                     | 雞肉[電宰](/business/knowledge-cards/mechanized-slaughter/) |
...
超秦的品牌化最間接——透過集團內的揚秦國際（麥味登、炸雞大獅）消化產能。超秦賣給揚秦的雞肉價格比賣給外部客戶高（[關係人交易](/business/knowledge-cards/related-party-transaction/)加價），揚秦再透過加盟店的終端售價獲利。兩間公司合計的利潤比任何一間單獨看都高。
...
卜蜂 2024 年毛利率 16.4%、2025 年跳到 21.2%——其中約 2-3 個百分點來自加工品佔比提升和垂直整合深化（結構性），3-4 個百分點來自豬價暴漲（一次性）。2026 Q1 毛利率回落、[EPS](/business/knowledge-cards/eps/) 從 2.38 降到 1.26——豬價利好回吐，但結構性改善保留。如果 2026 全年毛利率穩在 18-19%（高於 2024 的 16.4%），代表垂直整合和加工品轉型的投資確實產出了持續的利潤改善。（詳見[雞肉供應鏈三廠比較](/business/financial-analysis/chicken-supply-chain-comparison/)的卜蜂拆解段）
...
超秦+揚秦的合計效益：超秦毛利率 16.6%、[淨利率](/business/knowledge-cards/net-margin/) 5.2%；揚秦毛利率 27.4%、淨利率 7.7%。如果把兩間公司視為一個集團，合計營收約 70 億、合計淨利約 4.5 億、合計淨利率約 6.4%——高於超秦單獨的 5.2%，反映下游品牌對集團整體的利潤提升效果。
...
大成的規模分散策略（飼料→食品轉型路徑、100 億 capex 去向、Amy Food 美國併購、供應鏈雙重地位）的深度分析見[大成的規模分散策略](/business/financial-analysis/case-studies/dachan-scale-diversification-strategy/)。
