...
| 項目                                                                                                                                                                                                                                                                               | 類型 | 前置條件                                                     | 規模 |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---- | ------------------------------------------------------------ | ---- |
| 財務指標表格補期間標示（含真實財務數字而未標年度／季度的比較表，掃描命中約 50 處、散在 37 篇；概念型表格如估值倍數公式不在此列，逐篇要先判真偽再補）                                                                                                                               | 主章 | 無（掃描指令與判讀方式見下段）                               | 中   |
...
掃描的判準是「表格含真實財務數字，而表格本身與前三行都沒有年度、季度或 FY 標記」。命中是候選不是判決：概念型表格（估值倍數的公式對照、Gross 與 Net 認列的差異、成本科目的分類）本來就不繫於特定期間，不需要補。要補的是帶有具體數值的那一類——營收、毛利率、EPS、ROE 的實際數字。
