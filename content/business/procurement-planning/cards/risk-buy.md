...
該不該 Risk Buy，看幾件事：市場是否傳出某類料要缺、這顆料的 LT 是否長到「等需求確定再下單就來不及」、上游零件是否出現漲價或緊縮。市場傳 GPU 缺料時，先備足兩家 MOSFET 並跟原廠綁季度產能，Server 案子就不會被單一供應商卡死—這就是把上游趨勢轉成 Risk Buy 動作的例子。
