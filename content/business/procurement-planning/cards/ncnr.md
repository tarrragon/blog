...
NCNR 站在「先卡產能」與「承擔呆料」之間。若一個料號在改單截止日前可以無條件修改或取消，就能大膽先下遠期單卡住產能，之後再依實際需求調整。反過來，NCNR 或已過截止日的單，等於買斷，要用 [Forecast](/business/procurement-planning/cards/forecast/) 信心足夠的量才下。判斷一顆料的下單策略前，要先釐清它受哪些原廠與代理商規則約束。
