...
獨立性可以被設計，能動的有四件事：需求的來源、產出的順序、產出的主體，以及時間間隔。前三件是本節展開的重點；**時間間隔**在開場已經出現過：寫實作與寫測試之間隔一段時間，中間發生一次重新理解需求的動作。它在人手寫的年代是免費附贈的，產出速度提高之後要刻意安排，而它也是四件裡最不可靠的一件（間隔不保證有人會回去讀需求）。
