...
- 條件由誰寫、為什麼不能與實作同源 → [判準的推導來源](/testing/06-agent-authored-code/test-provenance-independence/)
- 條件寫好之後怎麼量測試的偵測能力 → [品質閘門的更替](/testing/06-agent-authored-code/coverage-to-mutation-gate/)
- 這個判準抽出的可重用原則 → [#277 通過關卡不等於通過的是同一個程式](/report/passing-a-gate-does-not-pin-the-program/)
