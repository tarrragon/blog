...
數量還有另一種上游成因，跟遮蔽無關：替身數量隨測試邊界的位置變動——邊界畫在單一類別時，每個協作者各要一個替身，數量是設計選擇的下游而不是盲區的症狀。兩種成因的處方不同，判準見 [Sociable vs Solitary Unit Test](/testing/knowledge-cards/unit-definition-two-schools/)。
