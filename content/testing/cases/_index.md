...
- **外部案例**：開源專案與社群的已知測試陷阱，以及公開可回溯的對照實驗（third-party，引用公開來源）
...
| [T.C10](/testing/cases/acceptance-passes-eight-different-programs/) | 同一組驗收通過八個不同的程式                | unclebob/negative-test-experiment | acceptance           | 條件之間沒有交叉、判定順序未被規定 |
