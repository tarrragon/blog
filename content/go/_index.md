...
本系列從入門到進階會反覆使用 action、command、domain event、repository、port、adapter、[projection](../backend/knowledge-cards/projection) 等詞彙。若你在實戰或重構章節看到這些詞，可以先回到 [Go 教材核心術語](glossary/)，確認它們在這套教材中的責任邊界。
