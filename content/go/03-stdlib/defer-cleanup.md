...
- [Go 入門：testing 基礎](../../05-error-testing/testing-basics/)：測試裡的資源回收與 `t.Cleanup`，會比單純 close 更能說清楚責任。
...
- [Go：goroutine：輕量並發工作](../../04-concurrency/goroutine/)
- [Go：select：同時等待多種事件](../../04-concurrency/select/)
