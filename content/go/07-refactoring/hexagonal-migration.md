...
這個 usecase 只依賴 domain 與 ports。HTTP handler、WebSocket router、memory repository、[event [log](/backend/knowledge-cards/log/)](/go/backend/knowledge-cards/event-log) implementation 都在外面。
