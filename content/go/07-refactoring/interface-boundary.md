...
| [event [log](/backend/knowledge-cards/log/)](/go/backend/knowledge-cards/event-log) | 記錄實作可替換                                                        | `EventLog`                    |
...
- [Go 入門：interface：用行為定義依賴](/go/02-types-data/interfaces/)
- [Go 入門：testing 基礎](/go/05-error-testing/testing-basics/)
- [Go 進階：composition root 與依賴組裝](/go/07-refactoring/composition-root/)
