...
## 【判讀】dependency injection 的重點是方向，不是框架
...
1. 讀 config。
2. 建立 logger / metrics / tracer。
3. 建立 database / cache / broker client。
...
- broker connection、durable queue 與重試
