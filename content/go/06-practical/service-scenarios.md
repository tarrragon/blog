...
這一章先不談細節實作，而是先把 Go 常見會被用到的服務場景整理出來。對剛從 PHP 或 Python 轉來的讀者來說，先知道 Go 最常做哪些事，會更容易理解前面那些語言特性為什麼重要。
...
Go 最常出現的地方，通常不是最華麗的 UI 或最複雜的商業流程，而是服務邊界：
...
這些場景共通點都是：工作量大多是 I/O 與協調，不是單點重運算。
