...
Backfill 位在資料 schema、transform logic 或歷史資料修補之後，常出現在 data pipeline、database [migration](/ci/knowledge-cards/migration/)、search index rebuild 與 feature store 更新。
