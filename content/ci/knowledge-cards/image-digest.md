...
Image Digest 位在 image build、scan、[registry](/ci/knowledge-cards/container-registry/) promotion 與 runtime deploy 之間，通常以 `sha256:...` 形式標識 image manifest 或 image index。
