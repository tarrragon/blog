...
| [Infrastructure Drift](/ci/knowledge-cards/infrastructure-drift/) | 實際環境與宣告差異檢查 | 是否存在未受控手動變更        |
...
- [Infrastructure Drift](/ci/knowledge-cards/infrastructure-drift/) 偵測要定期執行，並有修復責任人。

## 學習路線

| 章節                                                                       | 主題                            | 核心責任                     |
| -------------------------------------------------------------------------- | ------------------------------- | ---------------------------- |
| [IaC plan、apply、drift 與 recovery 流程](plan-apply-drift-recovery-flow/) | Plan, apply, drift and recovery | 控制基礎設施變更、漂移與回復 |

## 下一步路由

- IaC 發布主流程：讀 [IaC plan、apply、drift 與 recovery 流程](plan-apply-drift-recovery-flow/)。
