...
| [Artifact 與可重播性](artifact-reproducibility/)            | Artifact reproducibility   | 讓 CI 產物能被測試與發布共用                    |
| [Flaky test 治理](flaky-test-governance/)                   | Flaky governance           | 把不穩定測試從雜訊變成可處理任務                |
...
- 想讓測試與發布共用同一份產物：讀 [Artifact 與可重播性](artifact-reproducibility/)。
- 想治理不穩定測試：讀 [Flaky test 治理](flaky-test-governance/)。
...
- 想理解 infra 變更的 plan / apply 流程怎麼走 CI：讀 [Infra 走 PR 流程與自動化護欄](/infra/07-infra-as-pr/)。
