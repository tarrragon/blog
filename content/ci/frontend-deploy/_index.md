...
| 章節                                                                      | 主題                        | 核心責任                                      |
| ------------------------------------------------------------------------- | --------------------------- | --------------------------------------------- |
| [前端 artifact 與 preview deployment 流程](static-artifact-preview-flow/) | Static artifact and preview | 串起 build、browser test、preview 與 rollback |

## 下一步路由

- 前端 artifact 流程：讀 [前端 artifact 與 preview deployment 流程](static-artifact-preview-flow/)。
