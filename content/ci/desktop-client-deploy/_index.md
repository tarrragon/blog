...
Desktop client 常見於 Flutter Desktop、Electron、Tauri。部署流程通常要分平台建置（macOS、Windows、Linux），並處理安裝體驗、[Release Channel](/ci/knowledge-cards/release-channel/) 更新節奏與版本共存。
...
| Update   | [Update Feed](/ci/knowledge-cards/update-feed/)、delta package | 升級是否穩定可回復   |
...
| 章節                                                                         | 主題                             | 核心責任                         |
| ---------------------------------------------------------------------------- | -------------------------------- | -------------------------------- |
| [Desktop client 簽章、公證與自動更新流程](signing-notarization-update-flow/) | Signing, notarization and update | 管理安裝包信任鏈、更新通道與回復 |

## 下一步路由

- Desktop 發布主流程：讀 [Desktop client 簽章、公證與自動更新流程](signing-notarization-update-flow/)。
