...
載體分清楚之後最有力的驗證是改動面：狀態流落地時，全 App 八十多個既有事件發布點**零改動**。事件仍然記錄業務事實、服務審計與跨 domain 通知；狀態流負責「資料變了」的觀測。兩者正交、互不取代：
